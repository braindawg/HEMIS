        ...
        <div class="profile-content">
            <div class="portlet box">        
                <div class="portlet-body">
                            <!-- BEGIN FORM-->            
                            {!! Form::model($noticeboard, ['route' => ['noticeboards.update', $noticeboard], 'method' => 'patch', 'class' => 'form-horizontal', 'files' => 'true']) !!}            
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-8">
                                            <button type="submit" class="btn green">{{ trans('general.save') }}</button>
                                                 <a href="{{ route('noticeboards.index') }}" class="btn default">{{ trans('general.cancel') }}</a>
                                        </div>
                                    </div>
                                </div>                            
                                {!! Form::close() !!}
